...
namespace FlowMind.Common.ViewModels
{
        ...
        private void UpdateMessageImage(MessageType type)
        {
            switch (type)
            {
                ...
                case MessageType.Information:
                    ...
                    MessageGeometry = Application.Current.Resources[ResourceKeys.InfomationGeometryKey] as Geometry;
                    break;

                case MessageType.Warning:
                    GeometryBrush = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#E7AF05"));
                    MessageGeometry = Application.Current.Resources[ResourceKeys.WarningGeometryKey] as Geometry;
                    break;

                case MessageType.Error:
                    GeometryBrush = Brushes.Red;
                    MessageGeometry = Application.Current.Resources[ResourceKeys.ErrorGeometryKey] as Geometry;
                    break;

                case MessageType.Question:
                    GeometryBrush = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#0979D7"));
                    MessageGeometry = Application.Current.Resources[ResourceKeys.QuestionGeometryKey] as Geometry;
                    break;
            }
        }
